...
`example(filterByYearPricePieceTheme)`
...
`example(groupByPiece)`

`example(groupByPieceAvg)`

`example(groupByPieceThemeAvg)`

`example(groupByPrice)`

`example(groupByTheme)`

### GGPlot

`example(ggplotSetsCountByYear)`

`example(ggplotPiecesCountByYear)`

`example(ggplotPriceByYear)`

`example(ggplotThemesCountByYear)`

`example(ggplotPieceByTheme)`
