...
All of the helper functions above are useful for shaping the data to plot the data - so to see some interactive plots the following functions were created.
...
```{r, fig.show='hold', results='asis', comment=NA}
require(rCharts)
require(knitr)
#plotSetsCountByYear(groupByYear(data))
#plotPiecesCountByYear(groupByPiece(data))$show("iframesrc", cdn=TRUE)
#knitr::include_app(runShinyLego())
```
